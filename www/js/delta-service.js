...
var render = function() {
	...
	map: THREE.ImageUtils.loadTexture('/firerest/img/FirePick-Delta-base.jpg') 
	  } );
	  var imgNoneMat = new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('/firerest/img/no-image.png') } );
