var firepick; (function (firepick) {
	...
	Evolve.prototype.solve = function(generation, isDone) {
		...
		for (this.iGeneration = 0; (this.status=isDone(this.iGeneration, this.generation)) === false; this.iGeneration++) {
	...
	console.log("INFO	: firepick.Evolve defined");
})(firepick || (firepick = {}));
...
var firepick; (function (firepick) {
	...
	console.log("INFO	: firepick.EvolveTest defined: " + JSON.stringify(firepick.EvolveTest));
})(firepick || (firepick = {}));
